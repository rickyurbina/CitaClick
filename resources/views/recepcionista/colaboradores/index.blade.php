...
@section('page_title', 'Gestión de Colaboradores')

@section('content')
    <div class="grid grid-cols-1 md:grid-cols-4 gap-lg mb-2xl">
        <div class="bg-secondary-container p-lg rounded-xl card-shadow border border-outline-variant col-span-1 relative overflow-hidden group cursor-pointer hover:opacity-90 transition-opacity">
        ...
        <div class="bg-secondary-container p-lg rounded-xl card-shadow border border-outline-variant col-span-1 md:col-span-2 relative overflow-hidden group">
            <div class="flex flex-col md:flex-row gap-md h-full items-center justify-center">
                <button class="flex-grow w-full md:w-auto bg-primary text-on-primary px-lg py-md rounded-lg font-label-md flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
                    <span class="material-symbols-outlined">check_circle</span>Terminar Turno
                </button>
                <button class="flex-grow w-full md:w-auto bg-secondary text-on-secondary px-lg py-md rounded-lg font-label-md flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
                    <span class="material-symbols-outlined">receipt_long</span>Corte de Turno
                </button>
            </div>
        </div>
    </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-surface-container-low border-b border-outline-variant">
                        <th class="px-lg py-md font-label-md text-label-md text-on-surface-variant">Seleccionar</th>
                        <th class="px-lg py-md font-label-md text-label-md text-on-surface-variant">Nombre del Colaborador</th>
                        <th class="px-lg py-md font-label-md text-label-md text-on-surface-variant">Citas Atendidas</th>
                ...
                <tbody class="divide-y divide-outline-variant">
                    <tr class="hover:bg-surface-container-lowest transition-colors">
                        <td class="px-lg py-md"><input class="rounded border-outline-variant text-primary focus:ring-primary" type="checkbox"></td>
                        <td class="px-lg py-md font-body-md text-body-md text-on-surface">Carlos Ruiz</td>
                        <td class="px-lg py-md font-body-md text-body-md text-on-surface">45 citas</td>
                        <td class="px-lg py-md"><span class="px-sm py-1 bg-secondary-container text-on-secondary-fixed-variant text-label-sm font-label-sm rounded-full">Activo</span></td>
                        <td class="px-lg py-md text-right">
                            <div class="flex justify-end gap-sm">
                                <button class="p-2 text-on-surface-variant hover:text-primary hover:bg-surface-container-high rounded-lg transition-all"><span class="material-symbols-outlined text-[20px]">edit</span></button>
                                <button class="p-2 text-on-surface-variant hover:text-error hover:bg-error-container rounded-lg transition-all"><span class="material-symbols-outlined text-[20px]">delete</span></button>
                            </div>
                        </td>
                    </tr>
                    <tr class="hover:bg-surface-container-lowest transition-colors">
                        <td class="px-lg py-md"><input class="rounded border-outline-variant text-primary focus:ring-primary" type="checkbox"></td>
                        <td class="px-lg py-md font-body-md text-body-md text-on-surface">Elena Gómez</td>
                        <td class="px-lg py-md font-body-md text-body-md text-on-surface">38 citas</td>
                        <td class="px-lg py-md"><span class="px-sm py-1 bg-secondary-container text-on-secondary-fixed-variant text-label-sm font-label-sm rounded-full">Activo</span></td>
                        <td class="px-lg py-md text-right">
                            <div class="flex justify-end gap-sm">
                                <button class="p-2 text-on-surface-variant hover:text-primary hover:bg-surface-container-high rounded-lg transition-all"><span class="material-symbols-outlined text-[20px]">edit</span></button>
