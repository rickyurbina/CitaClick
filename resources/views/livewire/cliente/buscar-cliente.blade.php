            ...
            <div class="flex flex-col items-center mb-xl">
                @if($empresa->logo_src)
                    <div class="w-[160px] h-[160px] md:w-[200px] md:h-[200px] flex items-center justify-center bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/30 p-md {{ $empresa->estatus === 'activo' ? '' : 'mb-lg' }}">
                        <img src="{{ $empresa->logo_src }}" alt="{{ $empresa->nombre }}" class="w-full h-full object-contain">
                    </div>
                @endif
            ...
            <div class="login-card bg-surface-container-lowest border border-outline-variant p-xl rounded-xl">
                ...
                @if($mensaje)
                    <div class="mb-lg p-md rounded-lg border flex justify-between items-start gap-md
                        ...
                        <button type="button" wire:click="$dispatch('limpiar-mensaje')" class="text-on-surface-variant hover:text-on-surface transition-colors shrink-0" aria-label="Cerrar mensaje">
