        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-md">
            ...
            <div class="flex items-end">
                <button wire:click="limpiarFiltros" type="button"
                        class="w-full flex items-center justify-center gap-2 px-md py-2 rounded-lg border border-outline text-on-surface hover:bg-surface-container-low transition-colors font-label-md text-label-md">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-outline-variant">
                    ...
                    <tr class="hover:bg-surface-container-low transition-colors group">
                        ...
                        <td class="px-lg py-4 font-body-md text-body-md text-on-surface">
                            {{ $colaborador->comision_porcentaje ? $colaborador->comision_porcentaje . '%' : 'N/A' }}
                        </td>
                        <td class="px-lg py-4">
                            <span class="px-3 py-1 rounded-full text-xs font-medium
                                @if($colaborador->activo) bg-secondary-container text-on-secondary-container
                        ...
                        <td class="px-lg py-4 text-right">
                            <div class="flex justify-end gap-sm">
                                <button wire:click="abrirEditar({{ $colaborador->id }})"
                                        type="button"
                                        class="p-2 text-on-surface-variant hover:bg-secondary-container hover:text-on-secondary-container rounded transition-colors"
                                        title="Editar">
                                ...
                                <button wire:click="toggleActivo({{ $colaborador->id }})"
                                        type="button"
                                        class="p-2 text-on-surface-variant hover:bg-surface-container-high rounded transition-colors"
                                ...
                                <button wire:click="eliminar({{ $colaborador->id }})"
                                        ...
                                        type="button"
                                        class="p-2 text-on-surface-variant hover:bg-error-container hover:text-error rounded transition-colors"
                                        title="Eliminar">
                    ...
                    <tr>
                        <td colspan="7" class="px-lg py-2xl text-center text-on-surface-variant">
                            <span class="material-symbols-outlined text-4xl text-outline mb-3 block">group_off</span>
                            <p class="font-body-md text-body-md">No hay colaboradores registrados</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
            ...
            <form wire:submit.prevent="guardar" class="p-lg space-y-md">
                <div class="flex flex-col gap-xs">
                    ...
                    <input type="text" wire:model="nombre"
                           class="w-full h-12 px-md border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary outline-none transition-all font-body-md text-body-md text-on-surface">
                ...
                <div class="flex flex-col gap-xs">
                    ...
                    @if($colaboradorIdEditar)
                        <p class="font-body-sm text-body-sm text-on-surface-variant mt-1">Dejar en blanco para mantener la actual</p>
                    @endif
                </div>
                ...
                <div class="grid grid-cols-2 gap-md">
                    <div class="flex flex-col gap-xs">
                        ...
                        <input type="time" wire:model="horarioInicio"
                               class="w-full h-12 px-md border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary outline-none transition-all font-body-md text-body-md text-on-surface">
                    ...
                    <div class="flex flex-col gap-xs">
                        ...
                        <input type="time" wire:model="horarioFin"
                               class="w-full h-12 px-md border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary outline-none transition-all font-body-md text-body-md text-on-surface">
