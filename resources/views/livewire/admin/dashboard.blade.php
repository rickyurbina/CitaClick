<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow p-4">
            ...
            <div class="text-2xl font-bold">{{ $stats['citasHoy'] }}</div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            ...
            <div class="text-2xl font-bold text-blue-600">${{ number_format($stats['efectivoHoy'], 2) }}</div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <h3 class="text-lg font-semibold mb-4">Evolución de Citas e Ingresos</h3>
                ...
                <div class="space-y-3">
                    @foreach($stats['ultimasCitas'] as $cita)
                        <div class="flex items-center justify-between text-sm">
                            <div>
                                <span class="font-medium">{{ $cita->cliente->nombre }}</span>
