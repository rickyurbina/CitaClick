            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-outline-variant">
                    ...
                    <tr class="hover:bg-surface-container-low transition-colors group">
                        ...
                        <td class="px-lg py-4 font-body-md text-body-md text-on-surface font-semibold">
                        ...
                        <td class="px-lg py-4">
                            <span class="px-3 py-1 rounded-full text-xs font-medium
                                @if($servicio->activo) bg-secondary-container text-on-secondary-container
                    ...
                    <tr>
                        <td colspan="6" class="px-lg py-2xl text-center text-on-surface-variant">
                            ...
                            <p class="font-body-md text-body-md">No hay servicios registrados</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="bg-surface-container-lowest rounded-xl border border-outline-variant max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-lg">
            ...
            <form wire:submit.prevent="guardar" class="p-lg space-y-md">
                ...
                <div class="flex flex-col gap-xs">
                    ...
                    <input type="number" min="5" step="5" wire:model="duracion"
                           class="w-full h-12 px-md border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary outline-none transition-all font-body-md text-body-md text-on-surface">
                ...
                <div class="flex flex-col gap-xs">
                    ...
                    <input type="number" min="0" wire:model="puntos"
                           class="w-full h-12 px-md border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary outline-none transition-all font-body-md text-body-md text-on-surface"
                           placeholder="10">
